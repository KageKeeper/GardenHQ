namespace GardenManager.Web.DataContexts.GardenMigrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<GardenManager.Web.DataContexts.GardenDb>
    {
        ...
        protected override void Seed(GardenManager.Web.DataContexts.GardenDb context)
        {
